...
cd ~ && mkdir mnt
wget https://github.com/RasPlex/RasPlex/releases/download/1.8.0b/RasPlex-1.8.0b.148-573b6d73-RPi2.arm.img.gz
...
cd /home/frs/project/pinn-matthuisman/os/RasPlex_RPi2
put boot.tar.xz
exit
