...
cd ~ && mkdir mnt
wget https://github.com/RasPlex/RasPlex/releases/download/1.8.0b/RasPlex-1.8.0.0b-573b6d73-RPi3bplus.arm.img.gz
...
cd /home/frs/project/pinn-matthuisman/os/RasPlex_RPi3+
put boot.tar.xz
exit
